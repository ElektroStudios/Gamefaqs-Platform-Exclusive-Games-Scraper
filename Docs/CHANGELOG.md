...
This release should be fully stable. It was able to scrap the game lists in GameFAQs website for all the current 114 supported platforms entirely without suffering a ban, running for more than an entire week 24/7.
