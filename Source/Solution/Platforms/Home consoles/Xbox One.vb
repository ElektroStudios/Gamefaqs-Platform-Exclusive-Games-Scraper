...
Namespace Platforms
    ...
    ''' Xbox One platform.
    ''' </summary>
    Friend NotInheritable Class XboxOne : Inherits PlatformBaseWithOnlineStore

#Region " Properties "

        Friend Overrides ReadOnly Property PlatformInfo As _
            New PlatformInfo("Xbox One", "xboxone", PlatformType.HomeConsole)

        Protected Overrides ReadOnly Property MarketDistributionIds As New Dictionary(Of Integer, String) From {
            {28, "Xbox Store"},
            {35, "Creators Collection"}
        }
